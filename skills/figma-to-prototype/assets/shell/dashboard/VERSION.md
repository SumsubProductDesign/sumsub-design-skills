...
| font | Geist Variable, woff2 from `static.sumsub.com/checkus/assets/asset-ior2l1ew.woff2`, inlined as base64 (70 KB). Geist is published by Vercel under the **SIL Open Font License 1.1**, which permits redistribution of the font file, including bundled inside this repository — the copy here (`geist-variable.woff2`) is the product's own build, unmodified |
